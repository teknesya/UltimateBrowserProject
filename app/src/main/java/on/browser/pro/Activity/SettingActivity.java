...
import on.browser.pro.Task.ImportBookmarksTask;
import on.browser.pro.Task.ImportWhitelistTask;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == IntentUnit.REQUEST_BOOKMARKS) {
            if (resultCode != Activity.RESULT_OK || data == null || data.getData() == null)
                OnBrowserProToast.show(this, R.string.toast_import_bookmarks_failed);
            else {
            ...
            if (resultCode != Activity.RESULT_OK || data == null || data.getData() == null)
                OnBrowserProToast.show(this, R.string.toast_import_whitelist_failed);
            else {
                File file = new File(data.getData().getPath());
